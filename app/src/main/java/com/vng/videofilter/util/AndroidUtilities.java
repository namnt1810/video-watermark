...
public final class AndroidUtilities {
    ...
    public static int sp(float sp) {
        ...
        return (int) Math.ceil(TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, sp, App.getInstance().getResources().getDisplayMetrics()));
    }

    public static int sp2(float sp) {
        if (sp == 0) {
            return 0;
        }

        return (int) Math.floor(TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, sp, App.getInstance().getResources().getDisplayMetrics()));
    }
